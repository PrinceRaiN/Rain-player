...
class Screen(QMainWindow, SCREEN):
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QIcon(scriptDir + os.path.sep + 'icons/rain.png'))
        self.setupUi(self)
        pitmap = QPixmap("icons/rain.png")
...
class Player(QMainWindow, PLAYER):
    def __init__(self, parent=None):
        ...
        self.default_image = QPixmap("icons/rain.png")
        ...
        self.aniType = "left"
        self.actionExit_3.triggered.connect(self.exit_gui)
